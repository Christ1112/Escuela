...
<?php
echo "<body class='formulario-inicio' style='background-color: black;'>";
...
$n1 = @$_POST["n1"];
  ...
  $usuario = "root";
    ...
    if(isset($_POST['submit3'])){
      ...
      $query="Delete From alumnos where IDP=". $selected2 ;
    ...
    header("Location: modificarP.php?IDP=".$selected2); 
  }
    }

echo "<hr>"; ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

echo "<h3 style='color: white;'>Bienvenido</h3><h2 style='color: white;'> ".$n1." </h2style='color: white;'>a la tabla <h2style='color: white;'>Alumnos</h2>";
...
$query="Select * From alumnos";
  ...
  echo "<td bgcolor='#71BEFF'>ID</td>";
        ...
        echo "<td bgcolor='#9FF781'>Calificacion Final</td>";
        echo "</td>";
...
echo "&nbsp;&nbsp;";
 ...
 echo "</form>";
 echo "<br>";
 echo "<a href='agpro.php' type='button' class='btn' style='background-color: #694a24; color: white;'>Agregar Usuario</a>";
 echo "&nbsp;&nbsp;";
