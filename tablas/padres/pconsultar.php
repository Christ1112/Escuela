...
$n1 = @$_POST["n1"];
  ...
  $usuario = "root";
    ...
    header("Location: pmodificarP.php?IDPP=".$selected2); 
  }
    }

echo "<hr>"; ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

echo "<h3 style='color: white;'>Bienvenido</h3><h2 style='color: white;'> ".$n1." </h2style='color: white;'>a la tabla <h2style='color: white;'>Padres de Familia</h2>";
...
$query="Select * From padres";
    ...
    echo "<br><form name='formulario' method='post' action='pbuscarUP.php'>";
  ...
  echo "<form name='formulario' method='post' action='pconsultar.php'>";
...
echo "&nbsp;&nbsp;";
 ...
 echo "</form>";
 echo "<br>";
 echo "<a href='pagpro.php' type='button' class='btn' style='background-color: #694a24; color: white;'>Agregar Usuario</a>";
 echo "&nbsp;&nbsp;";
