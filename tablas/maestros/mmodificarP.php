...
$query="SELECT * FROM `maestros` WHERE `maestros`.`IDM` = ".$id.";";
...
while ($columna = mysqli_fetch_array( $resul )){
    ...
    echo "<form name='formulario' method='post' action='mmodificadoP.php'>";
    ...
    echo "<span class='input-group-text' id='basic-addon1'>➝</span>";
    echo "</div>";
    echo "<br> <input type='text' placeholder='Carrera Impartida' class='form-control' name='V5' value='".$columna['imparte']."'><br>";
    echo "</div>";
    echo "<div class='input-group mb-3'>";
    echo "<div class='input-group-prepend'>";
    echo "<span class='input-group-text' id='basic-addon1'>➝</span>";
    echo "</div>";
        echo "<br> <input type='text' placeholder='Correo Electronico' class='form-control' name='V6' value='".$columna['correo']."'><br>";
        echo "</div>";
    echo "<div class='input-group mb-3'>";
    echo "<div class='input-group-prepend'>";
    echo "<span class='input-group-text' id='basic-addon1'>➝</span>";
    echo "</div>";
        echo "<br> <input type='text' placeholder='Numero Contacto' class='form-control' name='V7' value='".$columna['numero']."'><br>";
        echo "</div>";
    echo "<div class='input-group mb-3'>";
    echo "<div class='input-group-prepend'>";
    echo "<span class='input-group-text' id='basic-addon1'>➝</span>";
    echo "</div>";
        echo "<br> <input type='date' class='form-control' name='V8' value='".$columna['cumpleaños']."'><br>";
        echo "</div>";
        echo "</div>";
echo "</center>";
echo "<input type='submit' name='Actualizar' class='btn' style='background-color: #694a24; color: white;' value='Actualizar'><br><br>";
echo "</form>";
echo "<br><br><a href='mconsultar.php' class='btn' style='background-color: #694a24; color: white;'>Ir a Consultas</a>";
}
//<!--FOOTHER------------------------------------------------------------------------------------------------------------------------------------->
include "../../foother.php";
?>