...
<head>
    ...
    <link rel="shortcut icon" href="../../IMG/logocircular.jpg">
...
$n1 = @$_POST["n1"];
  ...
  $usuario = "root";
    ...
    header("Location: mmodificarP.php?IDM=".$selected2); 
  }
    }

echo "<hr>"; ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

echo "<h3 style='color: white;'>Bienvenido</h3><h2 style='color: white;'> ".$n1." </h2style='color: white;'>a la tabla <h2style='color: white;'>Profesores</h2>";
...
$query="Select * From maestros";
    ...
    echo "<br><form name='formulario' method='post' action='mbuscarUP.php'>";
  ...
  echo "<form name='formulario' method='post' action='mconsultar.php'>";
...
echo "&nbsp;&nbsp;";
 ...
 echo "</form>";
 echo "<br>";
 echo "<a href='magpro.php' type='button' class='btn' style='background-color: #694a24; color: white;'>Agregar Usuario</a>";
 echo "&nbsp;&nbsp;";
