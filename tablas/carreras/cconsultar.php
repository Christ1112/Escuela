...
<body class="formulario-inicio" style="background-color: black;">
  ...
  $usuario = "root";
    ...
    header("Location: cmodificarP.php?IDC=".$selected2); 
  }
    }

echo "<hr>"; ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

echo "<h3 style='color: white;'>Bienvenido</h3><h2 style='color: white;'> ".$n1." </h2style='color: white;'>a la tabla <h2style='color: white;'>Licenciaturas</h2>";
...
$query="Select * From carreras";
    ...
    echo "<br><form name='formulario' method='post' action='cbuscarUP.php'>";
  ...
  echo "<form name='formulario' method='post' action='cconsultar.php'>";
  ...
  echo "<td bgcolor='#71BEFF'>ID</td>";
        ...
        echo "<td bgcolor='#71BEFF'>Duracion</td>";
        echo "</td>";
...
echo "&nbsp;&nbsp;";
 ...
 echo "</form>";
 echo "<br>";
 echo "<a href='cagpro.php' type='button' class='btn' style='background-color: #694a24; color: white;'>Agregar Usuario</a>";
 echo "&nbsp;&nbsp;";
